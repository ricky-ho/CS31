...
int main()
{
    ...
    if (numApprove < numDisapprove)     // the > was changed to <, thus if numApprove is less than numDisapprove
                                        // the output would say that more people approved than disapproved
                                        // and vice versa
